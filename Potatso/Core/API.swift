...
typealias waDateFormatter = ObjectMapper.ISO8601DateFormatter
...
extension RuleSet: BaseMappable {
...
extension Alamofire.DataRequest {
    ...
    public static func ObjectMapperSerializer<T: BaseMappable>(_ keyPath: String?, mapToObject object: T? = nil) -> DataResponseSerializer<T> {
    ...
    public func responseObject<T: BaseMappable>(_ queue: DispatchQueue? = nil, keyPath: String? = nil, mapToObject object: T? = nil, completionHandler: @escaping (DataResponse<T>) -> Void) -> Self {
    ...
    public static func ObjectMapperArraySerializer<T: BaseMappable>(_ keyPath: String?) -> DataResponseSerializer<[T]> {
        return DataResponseSerializer { request, response, data, error in
            DDLogVerbose("Alamofire response ===> request: \(request.debugDescription), response: \(response.debugDescription)")
            guard error == nil else {
                logError(error! as NSError, request: request, response: response)
    ...
    /**
     ...
     - returns: The request.
     */
    public func responseArray<T: BaseMappable>(_ queue: DispatchQueue? = nil, keyPath: String? = nil, completionHandler: @escaping (DataResponse<[T]>) -> Void) -> Self {
