...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ShadowPath/ShadowPath.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ShadowSocks-libev-iOS/ShadowSocks_libev_iOS.framework"
