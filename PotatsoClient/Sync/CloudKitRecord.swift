...
public let potatsoSubscriptionId = "allSubscription"
...
public func changeLocalRecord(_ record: CKRecord) throws {
...
public func deleteLocalRecord(_ recordID: CKRecord.ID) throws {
